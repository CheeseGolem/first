package com.first.req.user;

import com.first.req.QueryReq;
...
public class UserQueryReq extends QueryReq {
    ...
    /** 用户类型 {@link com.first.enumeration.user.UserTypeEnum} */
    private Integer userType;

    /** 账号状态 {@link com.first.enumeration.user.UserStateEnum } */
    ...
    /** 根据注册时间排序 {@link com.first.enumeration.OrderEnum} */
